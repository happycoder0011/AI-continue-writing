      ...
      <Flex direction="column" gap="3">
        ...
        */}
        <Flex direction="column" gap="1">
          ...
          <Text size="1" color="gray">
            Review the AI-generated text (highlighted in italics) and choose an action:
          </Text>
        </Flex>
        ...
        */}
        ...
        {/* 
          ...
          Shows users they can also use keyboard
        */}
        <Flex gap="2" style={{ fontSize: '12px', color: '#6b7280' }}>
          <Text size="1">
            💡 Tip: You can also manually edit the highlighted text before accepting
          </Text>
        </Flex>
      </Flex>
    </Card>
...
// Inject styles
if (typeof document !== 'undefined' && !document.getElementById('ai-toolbar-styles')) {
